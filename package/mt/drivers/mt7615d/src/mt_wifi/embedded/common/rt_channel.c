...
CH_DESC Country_Region0_ChDesc_2GHZ[] = { { 1, 11, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region1_ChDesc_2GHZ[] = { { 1, 13, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region2_ChDesc_2GHZ[] = { { 10, 2, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region3_ChDesc_2GHZ[] = { { 10, 4, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region4_ChDesc_2GHZ[] = { { 14, 1, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region5_ChDesc_2GHZ[] = { { 1, 14, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region6_ChDesc_2GHZ[] = { { 3, 7, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region7_ChDesc_2GHZ[] = { { 5, 9, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region31_ChDesc_2GHZ[] = { { 1, 11, CHANNEL_DEFAULT_PROP },
					   { 12, 3, CHANNEL_PASSIVE_SCAN },
					   {} };

CH_DESC Country_Region32_ChDesc_2GHZ[] = { { 1, 11, CHANNEL_DEFAULT_PROP },
					   { 12, 2, CHANNEL_PASSIVE_SCAN },
					   {} };

CH_DESC Country_Region33_ChDesc_2GHZ[] = { { 1, 14, CHANNEL_DEFAULT_PROP },
					   {} };
...
CH_DESC Country_Region0_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					  { 149, 5, CHANNEL_DEFAULT_PROP },
					  {} };

CH_DESC Country_Region1_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					  { 100, 11, CHANNEL_DEFAULT_PROP },
					  {} };

CH_DESC Country_Region2_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region3_ChDesc_5GHZ[] = { { 52, 4, CHANNEL_DEFAULT_PROP },
					  { 149, 4, CHANNEL_DEFAULT_PROP },
					  {} };

CH_DESC Country_Region4_ChDesc_5GHZ[] = { { 149, 5, CHANNEL_DEFAULT_PROP },
					  {} };
CH_DESC Country_Region5_ChDesc_5GHZ[] = { { 149, 4, CHANNEL_DEFAULT_PROP },
					  {} };

CH_DESC Country_Region6_ChDesc_5GHZ[] = { { 36, 4, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region7_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					  { 100, 11, CHANNEL_DEFAULT_PROP },
					  { 149, 5, CHANNEL_DEFAULT_PROP },
...
CH_DESC Country_Region8_ChDesc_5GHZ[] = { { 52, 4, CHANNEL_DEFAULT_PROP }, {} };

CH_DESC Country_Region9_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					  { 100, 5, CHANNEL_DEFAULT_PROP },
					  { 132, 3, CHANNEL_DEFAULT_PROP },
					  { 149, 5, CHANNEL_DEFAULT_PROP },
					  {} };

CH_DESC Country_Region10_ChDesc_5GHZ[] = { { 36, 4, CHANNEL_DEFAULT_PROP },
					   { 149, 5, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region11_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 100, 6, CHANNEL_DEFAULT_PROP },
					   { 149, 4, CHANNEL_DEFAULT_PROP },
					   {} };

/* for FCC capable of using 144 , mapping of Country_Region1 */
CH_DESC Country_Region12_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 100, 12, CHANNEL_DEFAULT_PROP },
					   {} };
/* for FCC capable of using 144 , mapping of Country_Region7 */
CH_DESC Country_Region13_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 100, 12, CHANNEL_DEFAULT_PROP },
					   { 149, 5, CHANNEL_DEFAULT_PROP },
					   {} };
/* for FCC capable of using 144 , mapping of Country_Region9 */
CH_DESC Country_Region14_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 100, 5, CHANNEL_DEFAULT_PROP },
					   { 132, 4, CHANNEL_DEFAULT_PROP },
					   { 149, 5, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region15_ChDesc_5GHZ[] = { { 149, 7, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region16_ChDesc_5GHZ[] = { { 52, 4, CHANNEL_DEFAULT_PROP },
					   { 149, 5, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region17_ChDesc_5GHZ[] = { { 36, 4, CHANNEL_DEFAULT_PROP },
					   { 149, 4, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region18_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 100, 5, CHANNEL_DEFAULT_PROP },
					   { 132, 3, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region19_ChDesc_5GHZ[] = { { 56, 3, CHANNEL_DEFAULT_PROP },
					   { 100, 11, CHANNEL_DEFAULT_PROP },
					   { 149, 4, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region20_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 100, 7, CHANNEL_DEFAULT_PROP },
					   { 149, 4, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region21_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 100, 11, CHANNEL_DEFAULT_PROP },
					   { 149, 4, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region22_ChDesc_5GHZ[] = { { 100, 11, CHANNEL_DEFAULT_PROP },
					   {} };

CH_DESC Country_Region35_ChDesc_5GHZ[] = { { 36, 8, CHANNEL_DEFAULT_PROP },
					   { 132, 4, CHANNEL_DEFAULT_PROP },
					   { 149, 5, CHANNEL_DEFAULT_PROP },
					   {} };
...
CH_GROUP_DESC Channel_GRP[] = { { 36, 4 },
				{ 52, 4 },
				{ 100, 12 },
				{ 149, 5 },
				{} };
...
CH_REGION ChRegion[] = {
	...
	{ "KP", CE, TRUE,
	  Country_KP_ChDesp }, /* Korea, Democratic People's Republic of */
	...
	{ "VC", CE, TRUE,
	  Country_VC_ChDesp }, /* Saint Vincent and the Grenadines */
...
PCH_REGION GetChRegion(IN PUCHAR CountryCode)
{
	INT loop = 0;
	PCH_REGION pChRegion = NULL;

	while (strcmp((RTMP_STRING *)ChRegion[loop].CountReg, "") != 0) {
		if (strncmp((RTMP_STRING *)ChRegion[loop].CountReg,
			    (RTMP_STRING *)CountryCode, 2) == 0) {
...
static VOID ChBandCheck(IN UCHAR rfic, OUT PUCHAR pChType)
{
	*pChType = 0;
...
static UCHAR FillChList(IN PRTMP_ADAPTER pAd, IN PCH_DESP pChDesp,
			IN UCHAR Offset, IN UCHAR increment,
			IN UCHAR regulatoryDomain, struct wifi_dev *wdev)
{
	...
	for (i = 0; i < pChDesp->NumOfCh; i++) {
		...
		if (!strncmp((RTMP_STRING *)pAd->CommonCfg.CountryCode, "JP",
			     2)) {
		...
		CFG80211OS_ChanInfoInit(pAd->pCfg80211_CB, j,
					pChCtrl->ChList[j].Channel,
					pChCtrl->ChList[j].MaxTxPwr,
					WMODE_CAP_N(PhyMode), (bw == BW_20));
	...
	MTWF_LOG(
		...
		("\x1b[1;33m [FillChList] Test - pChCtrl->ChListNum = %d \x1b[m \n",
		 pChCtrl->ChListNum));

	return j;
}

static UCHAR CeateChListByRf(RTMP_ADAPTER *pAd, UCHAR RfIC,
			     PCH_REGION pChRegion, UCHAR Geography,
			     UCHAR offset, struct wifi_dev *wdev)
{
	UCHAR i;
	PCH_DESP pChDesp;
	UCHAR ChType;
	...
	if (IsRfSupport) {
		...
		for (i = 0; pChDesp[i].FirstChannel != 0; i++) {
			...
			if ((pChDesp[i].Geography == BOTH) ||
				...
				if (pAd->CommonCfg.DfsType != MAX_RD_REGION)
					regulatoryDomain =
						pAd->CommonCfg.DfsType;
				else
					regulatoryDomain =
						pChRegion->op_class_region;

				offset = FillChList(pAd, &pChDesp[i], offset,
						    increment, regulatoryDomain,
						    wdev);
			}
		}
#ifdef RT_CFG80211_SUPPORT
		if (ChType == BAND_5G) {
			if (CFG80211OS_UpdateRegRuleByRegionIdx(
				    pAd->pCfg80211_CB, NULL, pChDesp) != 0)
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL,
					 DBG_LVL_ERROR,
					 ("Update RegRule 5G failed!\n"));
		} else if (ChType == BAND_24G) {
			if (CFG80211OS_UpdateRegRuleByRegionIdx(
				    pAd->pCfg80211_CB, pChDesp, NULL) != 0)
				MTWF_LOG(DBG_CAT_ALL, DBG_SUBCAT_ALL,
					 DBG_LVL_ERROR,
...
static inline VOID CreateChList(IN PRTMP_ADAPTER pAd, IN PCH_REGION pChRegion,
				IN UCHAR Geography, struct wifi_dev *wdev)
{
	UCHAR offset = 0;
	/* INT i,PhyIdx; */
	/* PCH_DESP pChDesp; */
	...
	os_zero_mem(pChCtrl->ChList,
		    MAX_NUM_OF_CHANNELS * sizeof(CHANNEL_TX_POWER));
	pChCtrl->ChListNum = 0;
	if (WMODE_CAP_2G(PhyMode))
		offset = CeateChListByRf(pAd, RFIC_24GHZ, pChRegion, Geography,
					 offset, wdev);
	if (WMODE_CAP_5G(PhyMode))
		offset = CeateChListByRf(pAd, RFIC_5GHZ, pChRegion, Geography,
					 offset, wdev);
}

VOID BuildChannelListEx(IN PRTMP_ADAPTER pAd, IN struct wifi_dev *wdev)
{
	PCH_REGION pChReg;
...
VOID BuildBeaconChList(IN PRTMP_ADAPTER pAd, IN struct wifi_dev *wdev,
...
#endif
			MakeOutgoingFrame(pBuf + *pBufLen, &TmpLen, 1,
					  &pChDesp[i].FirstChannel, 1,
					  &pChDesp[i].NumOfCh, 1,
					  &pChDesp[i].MaxTxPwr, END_OF_ARGS);
			*pBufLen += TmpLen;
		}
	}
}
...
UCHAR GetCountryRegionFromCountryCode(IN UCHAR *country_code)
{
	UCHAR ret = FCC;
	PCH_REGION pChReg;
...
BOOLEAN ExtChCheck(IN PRTMP_ADAPTER pAd, IN UCHAR Channel, IN UCHAR Direction,
		   IN struct wifi_dev *wdev)
{
	UCHAR ExtCh;
...
static const UCHAR wfa_ht_ch_ext[] = { 36,  EXTCHA_ABOVE,
				       40,  EXTCHA_BELOW,
				       44,  EXTCHA_ABOVE,
				       48,  EXTCHA_BELOW,
				       52,  EXTCHA_ABOVE,
...
VOID ht_ext_cha_adjust(RTMP_ADAPTER *pAd, UCHAR prim_ch, UCHAR *ht_bw,
		       UCHAR *ext_cha, struct wifi_dev *wdev)
{
	INT idx;
	...
	if (*ht_bw == HT_BW_40) {
		if (prim_ch > 14) {
			...
			do {
				...
				Dir = (Dir == EXTCHA_ABOVE) ? EXTCHA_BELOW :
								    EXTCHA_ABOVE;
				ExtCh = GetExtCh(prim_ch, Dir);
...
UINT8 GetCuntryMaxTxPwr(IN PRTMP_ADAPTER pAd, IN UCHAR PhyMode,
			IN struct wifi_dev *wdev, IN UCHAR ht_bw)
{
	int i;
...
void MTSetChGrp(RTMP_ADAPTER *pAd, RTMP_STRING *buf)
{
	...
	if (buf == NULL) {
		MTWF_LOG(
			...
			("[MTSetChGrp] (buf == NULL) Not enough memory for dynamic allocating\n"));
		return;
	}
	...
	for (BandIdx = 0, macptr2 = rstrtok(buf, ";"); macptr2;
	     macptr2 = rstrtok(buf, ";"), BandIdx++) {
		/*Get channel control*/
		/* 2.4G + 5G */
		...
		if (pAd->CommonCfg.eDBDC_mode == ENUM_DBDC_5G5G) {
			...
			MTWF_LOG(DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_OFF,
				 ("[MTSetChGrp] ENUM_DBDC_5G5G: BandIdx = %d\n",
				  BandIdx));
		} else {
		...
		NdisZeroMemory(pChCtrl->ChGrpABandChList,
			       (MAX_NUM_OF_CHANNELS) * sizeof(UCHAR));
		TotalChNum = 0;
		...
		if (buf_ChGrp == NULL) {
			MTWF_LOG(
				DBG_CAT_CFG, DBG_SUBCAT_ALL, DBG_LVL_ERROR,
				("[MTSetChGrp] (buf_ChGrp == NULL) Not enough memory for dynamic allocating\n"));
			return;
		}
		strncpy(buf_ChGrp, macptr2, len_macptr2);

		/*Check bit map of channel group of current HW band*/
		for (ChGrpIdx = 0, macptr = rstrtok(buf_ChGrp, ":");
		     (macptr && ChGrpIdx < Channel_GRP_Num);
		     macptr = rstrtok(NULL, ":"), ChGrpIdx++) {
			bEnable = 0;
			bEnable = (UCHAR)simple_strtol(macptr, 0, 10);
			pChDescGrp = &(Channel_GRP[ChGrpIdx]);
			if (bEnable == 1) {
				if ((TotalChNum + pChDescGrp->NumOfCh) <
				    MAX_NUM_OF_CHANNELS) {
					pChCtrl->ChGrpABandEn |=
						(1 << ChGrpIdx);
					for (ChIdx = 0;
					     ChIdx < pChDescGrp->NumOfCh;
					     ChIdx++) {
						if ((TotalChNum + ChIdx) <
						    MAX_NUM_OF_CHANNELS) {
							pChCtrl->ChGrpABandChList
								[TotalChNum +
								 ChIdx] =
								pChDescGrp
									->FirstChannel +
							...
							MTWF_LOG(
								...
								DBG_SUBCAT_ALL,
								DBG_LVL_TRACE,
								("[MTSetChGrp] Test - ChCtrl[%d]->ChGrpABandChList[%d]=%d\n",
								 BandIdx,
								 TotalChNum +
									 ChIdx,
								 pChDescGrp->FirstChannel +
									 (ChIdx *
									  4)));
						}
					}
		...
		MTWF_LOG(
			...
			("[MTSetChGrp] BandIdx =%d, pChCtrl->ChGrpABandChNum=%d, ChGrp=%d/%d/%d/%d\n",
...
BOOLEAN MTChGrpChannelChk(IN CHANNEL_CTRL *pChCtrl, IN UCHAR ch)
{
	UCHAR ChGrpIdx;
